 ...
 */
function calculateWarpNetWeight(tar, denier) {
 ...
 */
function calculateWeftNetWeight(peek, panna, denier) {
 ...
 */
function calculateRawCost(weight, yarnPrice, gstPercentage) {
 ...
 */
function calculateEstimate(inputs, weightPrecision = 4, costPrecision = 2) {
  const {
    warp,
    weft,
    weft2Enabled,
...
module.exports = {
  calculateWarpNetWeight,
  calculateWarpRawWeight,
  calculateWeftNetWeight,
